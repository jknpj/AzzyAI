...
* Added missing timeout globals to Const\_.lua
...
- New Feature: REACT\_ tactics to use attack or defense skills in response to monster casting on you.
...
- Global variables moved to Const\_.lua, this will make the code easier for me to manage.
